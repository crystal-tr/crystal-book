...
* [Kurulum](installation/README.md)
   * [Debian ve Ubuntu'da](installation/on_debian_and_ubuntu.md)
   * [RedHat ve CentOS'da](installation/on_redhat_and_centos.md)
   * [Arch Linux'da](installation/on_arch_linux.md)
   * [Gentoo Linux'da](installation/on_gentoo_linux.md)
   * [Mac OSX'da Homebrew kullanarak](installation/on_mac_osx_using_homebrew.md)
   * [Ubuntu on Windows üzerindeki Bash'de](installation/on_bash_on_ubuntu_on_windows.md)
   * [tar.gz'den](installation/from_a_targz.md)
   * [Kaynak kod üzerinden](installation/from_source_repository.md)
